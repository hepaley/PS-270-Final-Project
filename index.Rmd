...
Filter out NA and skips 
take outcomes yes or no and make new variable that is 0 when no and 1 if yes 
categorical outcomes, linear probabiltiy model (the probability of someone saying yes to support for the outcome) 
## Finding the P Value 
```{r}
library(infer)

abortions <-
  abortions |> filter(...17 != "BNE3_2") |> mutate(Simple_17 = if_else(...17 == "Yes" | 
                         ...17 == "Yes, I have" |
                         ...17 == "Yes, I know someone", "Yes", "Not Yes"))
